        ...
        <div class="row">
                <div class="add-corp-portfolio-wrapper">
                    <div class="add-corp-portfolio-container">
                        ...
                        <?= $this->Form->create(false, ['url' => ['action' => 'save'], 'type' => 'file', 'id' => 'frmAddPortfolio']) ?>
                        <div class="col-lg-12">
                            <div class="row-title">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="activity">Choose Category<span class="required_field"> *</span>
                                    <?php
                                    echo $this->Form->select('select-cat-id', $categoryList, ['class' => 'form-control', 'id' => 'select-cat-id', 'name' => 'select_cat']);
                                    ?>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="cor_fb_link">Facebook Link 
                                    <input type="text" id="cor_fb_link" class="form-control" name="cor_fb_link">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="cor_yt_link">Youtube Link
                                    <input type="text" id="cor_yt_link" class="form-control" name="cor_yt_link">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="button-set">
                                    <button type="submit" title="Add" class="button black_sm" id="btnAddPortfolio">Add</button>
