...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link href="./Privacy_Policy_files/demo.css" rel="stylesheet" type="text/css">
    </head>
    <body>
        <div class="wrap">
            <div class="page-head"><h2>Privacy Terms</h2></div>
            <div class="wrapeer">
                <div class="content">
                    <div class="heading">
                    ...
                    <div class="data">
                        <ul>
                            ...
                            <ul><p></p><li>We collect the content and other information you provide when you use our Services, including when you sign up for an account,<br> 
                                ...
                                <li>We also collect information about how you use our Services, such as the types of content you view or engage with or the frequency <br>
                                    and duration of your activities.</li><p></p></ul>

                            <li><span>Things others do and information they provide.</span></li>

                            <ul><p></p><li>We also collect content and information that other people provide when they use our Services, including information about you,<br> 
                                    such as when they share a photo of you, send a message to you, or upload, sync or import your contact information.</li><p></p></ul>
                            <li><span>Your networks and connections.</span></li>
                            <ul><p></p><li>We collect information about the people and groups you are connected to and how you interact with them, such as the people you <br>
                                    ...
                                    or import this information (such as an address book) from a device.</li><p></p></ul>
                            ...
                            <ul><p></p><li>We receive information about you and your activities on and off from third-party partners, such as information from a partner when <br>
                                    we jointly offer services or from an advertiser about your experiences or interactions with them.</li><p></p></ul>
                        </ul>
                    </div>
                </div>
                <div class="content">
                    ...
                    <div class="data">
                        <ul>
                            ...
                            <li><span>Here's how:<span></span></span></li><br>
                            <ul>
                                <li>Provide</li>
                                <li>improve</li>
                            ...
                            <ul><p>
                                </p><li>We use your information to send you marketing communications, communicate with you about our Services and let you know about our policies <br>and terms. </li>
                            ...
                            <ul><p></p><li>
                                ...
                                <ul><li>
                                    ...
                                    <li>For example, when you post, you select the audience for the post, such as a customized group of individuals, all of your Friends, or members of<br> a Group. </li></ul><p></p></ul>
