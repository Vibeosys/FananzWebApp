                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="layout-figure">
                        ...
                        <div class="figure-caption">
                            ...
                            <div class="cate-link">
                                <input type="hidden" name="hdnPortfolioId" value="73">              
...
<div class="banner-fananz">
    <div class="container">
        ...
        <div class="col-md-5 bb-grids bb-left-text">
            <a href="http://fananz.com/portfolio/models">
        ...
        <div class="col-md-4 col-xs-12 bb-grids bb-middle-text">
            <a href="http://fananz.com/portfolio/artists--belly-dancers">
                <div class="bb-middle-top">
                    <p>Solo Dance</p>
                </div>
            </a>
            <a href="http://fananz.com/portfolio/birthdays">
        ...
        <div class="col-md-3 col-xs-12 bb-grids bb-right-text">
            <a href="http://fananz.com/portfolio/media--photographers">
                <div class="bb-right-top">
                    <p>Photography Capture</p>
                </div>
            </a>
            <a href="http://fananz.com/portfolio/artists--singers">
